...
# var a = 2
# var b = "text"
var image_A = preload('res://Sprites/A.png')
var image_B = preload('res://Sprites/B.png')
var image_C = preload('res://Sprites/C.png')
var image_D = preload('res://Sprites/D.png')
var image_E = preload('res://Sprites/E.png')
var image_F = preload('res://Sprites/F.png')
var image_G = preload('res://Sprites/G.png')
# sharps
var image_A_sharp = preload('res://Sprites/A_sharp.png')
var image_B_sharp = preload('res://Sprites/B_sharp.png')
var image_C_sharp = preload('res://Sprites/C_sharp.png')
var image_D_sharp = preload('res://Sprites/D_sharp.png')
var image_E_sharp = preload('res://Sprites/E_sharp.png')
var image_F_sharp = preload('res://Sprites/F_sharp.png')
var image_G_sharp = preload('res://Sprites/G_sharp.png')
# flats
var image_A_flat = preload('res://Sprites/A_flat.png')
var image_B_flat = preload('res://Sprites/B_flat.png')
var image_C_flat = preload('res://Sprites/C_flat.png')
var image_D_flat = preload('res://Sprites/D_flat.png')
var image_E_flat = preload('res://Sprites/E_flat.png')
var image_F_flat = preload('res://Sprites/F_flat.png')
var image_G_flat = preload('res://Sprites/G_flat.png')
...
func switch_texture(note):
	...
	notename = note
	if  (note == 'A'):
		$Sprite.set_texture(image_A)

	elif(note == 'B'):
		$Sprite.set_texture(image_B)

	elif(note == 'C'):
		$Sprite.set_texture(image_C)
		
	elif(note == 'D'):
		$Sprite.set_texture(image_D)
#
	elif(note == 'E'):
		$Sprite.set_texture(image_E)
#
	elif(note == 'F'):
		$Sprite.set_texture(image_F)
		
	elif(note == 'G'):
		$Sprite.set_texture(image_G)
	
	elif  (note == 'A_flat'):
		$Sprite.set_texture(image_A_flat)

	elif(note == 'B_flat'):
		$Sprite.set_texture(image_B_flat)

	elif(note == 'C_flat'):
		$Sprite.set_texture(image_C_flat)
		
	elif(note == 'D_flat'):
		$Sprite.set_texture(image_D_flat)
#
	elif(note == 'E_flat'):
		$Sprite.set_texture(image_E_flat)
#
	elif(note == 'F_flat'):
		$Sprite.set_texture(image_F_flat)
		
	elif(note == 'G_flat'):
		$Sprite.set_texture(image_G_flat)
	
	elif  (note == 'A_sharp'):
		$Sprite.set_texture(image_A_sharp)

	elif(note == 'B_sharp'):
		$Sprite.set_texture(image_B_sharp)

	elif(note == 'C_sharp'):
		$Sprite.set_texture(image_C_sharp)
		
	elif(note == 'D_sharp'):
		$Sprite.set_texture(image_D_sharp)
#
	elif(note == 'E_sharp'):
		$Sprite.set_texture(image_E_sharp)
#
	elif(note == 'F_sharp'):
		$Sprite.set_texture(image_F_sharp)
		
	elif(note == 'G_sharp'):
		$Sprite.set_texture(image_G_sharp)
